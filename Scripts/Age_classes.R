...
bins<-c(10,30,60,100,250,500)
Cell_stats$bin_cut<-cut(Cell_stats$value,bins,include.lowest=T,labels =c("10-30","31-60","61-100","100-250",">250"))
...
P1<-ggplot(Cell_stats3,aes(x=as.factor(age),y=(Total2/27636)*100,fill=bin_cut))+geom_bar(stat="identity")+facet_wrap(~scenario)+scale_fill_brewer("Age",palette="Blues")
