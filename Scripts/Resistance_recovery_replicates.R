...
Res_summary2<-subset(Res_summary2,ESLab=="Carbon stock"|ESLab=="Nitrogen stock"|ESLab=="Recreation value"|ESLab=="Timber volume"|ESLab=="Fungi species richness"|ESLab=="Ground flora \nspecies richness"|ESLab=="Lichen species \nrichness"|ESLab=="Tree species richness")


Res_summary2$ESLab <- factor(Res_summary2$ESLab, c("Carbon stock", "Nitrogen stock", "Recreation value", "Timber volume",
